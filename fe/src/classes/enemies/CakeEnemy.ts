...
export class CakeEnemy extends BaseEnemy {
    ...
    constructor(
        ...
        maxHealth: number = (5 + (GameController.getInstance().currentWave / 3)) + (35 * GameController.getInstance().currentWave * GameController.getInstance().enemyHealth_Multiplier),
