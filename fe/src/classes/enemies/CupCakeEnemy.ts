...
export class CupCakeEnemy extends BaseEnemy {
    ...
    constructor(
        ...
        maxHealth: number = (5 + (GameController.getInstance().currentWave / 3)) + (50 * GameController.getInstance().currentWave * GameController.getInstance().enemyHealth_Multiplier),
