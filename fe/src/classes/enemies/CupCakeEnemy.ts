...
export class CupCakeEnemy extends BaseEnemy {
    ...
    constructor(
        ...
        maxHealth: number = (5 + (GameController.getInstance().currentWave / 2)) * (55 * GameController.getInstance().currentWave * GameController.getInstance().enemyHealth_Multiplier),
