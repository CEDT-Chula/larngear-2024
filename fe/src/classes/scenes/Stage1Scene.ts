...
export class Stage1Scene extends Phaser.Scene {
    ...
    create() {
        ...
        this.speedButton = this.add.text(this.cameras.main.width - 150, this.cameras.main.height - 50, 'Speed x1', {
            fontSize: '24px',
            backgroundColor: '#000',
            color: '#fff',
    ...
    handleSpeedToggle() {
        ...
        // Update the enemy speed multiplier
        ...
        // Apply the new game speed for enemies
        this.events.emit("speedChanged", gameController.enemySpeed_Multiplier);
    }

    resize() {
        this.speedButton.setPosition(this.cameras.main.width - 150, this.cameras.main.height - 50);
    }
